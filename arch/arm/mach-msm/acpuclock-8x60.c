...
static struct msm_bus_paths bw_level_tbl[] = {
	...
	[6] = BW_MBPS(5360), /* At least 558 MHz on bus. */
#else
	...
	[6] = BW_MBPS(3920), /* At least 410 MHz on bus. */
#endif
};
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[20] = {1458000,  1, 0x1B, 1225000, 1275000, 6},
	[21] = {1512000,  1, 0x1C, 1225000, 1275000, 6},
	[22] = {1566000,  1, 0x1D, 1225000, 1275000, 6},
};
