...
#define L_VAL_SCPLL_CAL_MAX	0x28 /* = 2314 MHz with 27MHz source */
...
static struct msm_bus_paths bw_level_tbl[] = {
	...
	[5] = BW_MBPS(4640), /* At least 473 MHz on bus. */
#else
...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 2158000,  ACPU_SCPLL, 0, 0, 1, 0x27, L2(22), 1600000, 0x03006000},
  { {1, 1}, 2210000,  ACPU_SCPLL, 0, 0, 1, 0x28, L2(22), 1625000, 0x03006000},
  { {1, 1}, 2314000,  ACPU_SCPLL, 0, 0, 1, 0x29, L2(22), 1650000, 0x03006000},
  { {0, 0}, 0 },
};
